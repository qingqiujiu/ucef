...
EVIDENCE_COLLECTIONS = {
    "fragments", "method_definitions", "execution_nodes", "field_inventory",
...
class IngestionValidator:
    ...
    def validate_record(
        ...
        if collection in {
            "trace_stages", "execution_nodes", "route_decisions", "field_lineage_steps",
            "persistence_effects", "external_interactions",
        }:
    ...
    def ingest(
        ...
        order = (
            "method_definitions", "fragments", "trace_stages", "execution_nodes", "field_inventory",
            "route_decisions", "field_lineage_steps",
