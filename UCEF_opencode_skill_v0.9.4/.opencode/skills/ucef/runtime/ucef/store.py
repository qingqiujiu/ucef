...
class FactStore:
    def __init__(self, db_path: str | Path):
        ...
        self.conn.execute("INSERT OR REPLACE INTO meta(key,value) VALUES('schema_version','0.9.4')")
        self.conn.commit()
    ...
    def scenario_dossier(self, scenario_id: str) -> dict[str, Any]:
        ...
        for collection in (
            "trace_stages", "execution_nodes", "field_inventory", "route_decisions", "field_lineage_steps",
        ...
        for collection in (
            "trace_stages", "execution_nodes", "field_inventory", "route_decisions",
