...
<nav class="top"><strong>UCEF</strong><a href="{relative_root}index.html">业务链路</a><a href="{relative_root}compare.html">横向对比</a></nav>
...
class DossierSiteBuilder:
    ...
    def build(self) -> dict[str, Any]:
        ...
        return {"output": str(self.output), "scenarios": len(scenarios), "files": len(scenarios) + 2}
